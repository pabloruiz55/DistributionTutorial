...
//dirty hack for web3@1.0.0 support, see https://github.com/trufflesuite/truffle-contract/issues/56#issuecomment-331084530
...
function readFile() {
  var stream = fs.createReadStream("scripts/allocation_data.csv");
